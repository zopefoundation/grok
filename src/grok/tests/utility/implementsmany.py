...
specify which interface to use for the registration:
  ...
  Traceback (most recent call last):
    ...
  martian.error.GrokError: <class 'grok.tests.utility.implementsmany.Club'> is implementing more than one interface (use grok.provides to specify which one to use).
"""  # noqa: E501
import grok
